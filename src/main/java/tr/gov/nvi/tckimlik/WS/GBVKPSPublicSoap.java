...
public class GBVKPSPublicSoap
{
    ...
    public GBVKPSPublicSoap(){}

    public GBVKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public GBVKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        GBVExtendedSoapSerializationEnvelope envelope= new GBVExtendedSoapSerializationEnvelope(GBVExtendedSoapSerializationEnvelope.VER11);
