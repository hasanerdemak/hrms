...
class GBVSoapFaultEx extends org.ksoap2.SoapFault
{
    public Object fault;
}
...
public class GBVExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(GBVDateTimeConverter converter)
    {
        if(converter==null)
        {
            converter = new GBVStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static GBVDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static GBVDateTimeConverter dateTimeConverter = new GBVStandardDateTimeConverter();

    public GBVExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public GBVExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new GBVMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=GBVHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,GBVExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=GBVHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
